/**
 * IRDAI-approved insurance companies by service category.
 * Source: IRDAI registered insurers list (verified August 2025).
 * To update: ask Claude to refresh from https://www.irdai.gov.in/web/guest/list-of-registered-insurers
 */
...
export const INSURANCE_COMPANIES = {
  "life-insurance": [
    ...
    "Navi Life Insurance Ltd.",
  ],

  "health-insurance": [
    // Standalone Health Insurers (SAHI) — IRDAI registered
    "Star Health and Allied Insurance Co. Ltd.",
    "Niva Bupa Health Insurance Company Ltd.",
    "Care Health Insurance Ltd.",
    "Aditya Birla Health Insurance Co. Ltd.",
    "ManipalCigna Health Insurance Company Ltd.",
    "Kotak Mahindra Health Insurance Ltd.",
    "Edelweiss Health Insurance Ltd.",
    // General insurers that predominantly offer health — often listed for health advisors
