...
import { computeGalleryBannerStats, galleryPageCopy } from "@/lib/gallery-config";
import type { GalleryItem } from "@/lib/gallery-types";
import { cn } from "@/lib/utils";

export function GalleryBanner({ items, className }: { items: GalleryItem[]; className?: string }) {
  const stats = computeGalleryBannerStats(items);
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-base sm:text-lg font-bold tracking-tight text-foreground leading-none">
                  {stat.value}
                </p>
